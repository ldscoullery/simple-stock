		...
		<div id="list-marca" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="detail" title="${message(code: 'marca.detail.label', default: 'Detail')}" />
				...
				<g:each in="${marcaInstanceList}" status="i" var="marcaInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${marcaInstance.id}">${fieldValue(bean: marcaInstance, field: "detail")}</g:link></td>
