	...
	<body>
		...
		<div id="show-marca" class="content scaffold-show" role="main">
			...
			<ol class="property-list marca">
				...
				<g:if test="${marcaInstance?.detail}">
				<li class="fieldcontain">
					<span id="detail-label" class="property-label"><g:message code="marca.detail.label" default="Detail" /></span>
					
						<span class="property-value" aria-labelledby="detail-label"><g:fieldValue bean="${marcaInstance}" field="detail"/></span>
