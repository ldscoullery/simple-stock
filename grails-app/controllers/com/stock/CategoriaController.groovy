...
class CategoriaController {
	...
	def savePersonalized() {
		println "Codigo: ${params.codeHidden}"
		println "Detalle: ${params.detailHidden}"
		println "Talle: ${params.sizeHidden}"
		println "Color: ${params.colorHidden}"
		Categoria categoriaInstance = new Categoria()
		categoriaInstance.detail = params.detail
		categoriaInstance.totalItems = params.inicialQuantity
		...
		//redirect(uri: "/producto/create")
		redirect(controller: "producto", action: "create", 
			params: [
				codigo : params.codeHidden, 
				detalle: params.detailHidden, 
				talle: params.sizeHidden, 
				color: params.colorHidden])
	}
