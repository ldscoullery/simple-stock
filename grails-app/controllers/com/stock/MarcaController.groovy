...
class MarcaController {
	...
	@Transactional
	def savePersonalized() {
		println "Codigo: ${params.codeHiddenMarca}"
		println "Detalle: ${params.detailHiddenMarca}"
		println "Talle: ${params.sizeHiddenMarca}"
		println "Color: ${params.colorHiddenMarca}"
		println "Cantidad: ${params.quantityHiddenMarca}"
		Marca marcaInstance = new Marca()
		marcaInstance.detail = params.detail
		...
		redirect(controller: "producto", action: "create", 
			params: [
				codigo : params.codeHiddenMarca, 
				detalle: params.detailHiddenMarca, 
				talle: params.sizeHiddenMarca, 
				color: params.colorHiddenMarca,
				cantidad: params.quantityHiddenMarca])
	}
